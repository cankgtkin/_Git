...
using ZeyrekFramework.Core.CrossCuttingConcerns.Caching;

namespace ZeyrekFramework.Core.Aspects.Postsharp.CacheAspects
{
    [Serializable]
    public class CacheRemoveAspect : OnMethodBoundaryAspect
    {
        ...
        {
            _cacheManager.Remove(string.IsNullOrEmpty(_pattern)
